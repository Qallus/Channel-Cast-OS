...
export const config = {
  ...
  matcher: [
    "/((?!_next/static|_next/image|favicon.ico|api/|agent.py|install.ps1|install.sh|install-display.sh|install-display.ps1|install-display.bat|.*\\.(?:svg|png|jpg|jpeg|gif|webp|ico|txt)$).*)",
  ],
};
