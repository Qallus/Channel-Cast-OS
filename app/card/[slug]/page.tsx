...
import { loadPublicCardBySlug, recordEvent } from "@/lib/business-cards/store";
...
export default async function PublicCardPage({
  ...
  const base = (process.env.NEXT_PUBLIC_APP_URL || "https://os.channelcast.io").replace(/\/$/, "");
  const publicUrl = `${base}/card/${card.slug}`;
