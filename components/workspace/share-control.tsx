...
export function ShareControl({
  ...
  async function refreshSharing() {
    const res = await fetch(`/api/admin/workspace/documents/${documentId}/collaborators`);
  ...
  async function patchScope(next: WorkspaceScope) {
    setLocalScope(next);
    await fetch(`/api/admin/workspace/documents/${documentId}`, {
      method: "PATCH",
  ...
  async function add(userId: string) {
    setQ("");
    await fetch(`/api/admin/workspace/documents/${documentId}/collaborators`, {
      method: "POST",
      headers: { "Content-Type": "application/json" },
