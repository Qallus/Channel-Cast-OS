...
function ChartTooltipContent({
  ...
  return (
    <div className={cn("border-border/50 bg-popover grid min-w-[8rem] items-start gap-1.5 rounded-lg border px-2.5 py-1.5 text-xs shadow-xl", className)}>
...
// Extract the item config from a payload key.
