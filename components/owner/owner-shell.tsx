...
import { LayoutDashboard, LogOut, MapPin, Menu, MonitorSpeaker, Store, Wallet, X } from "lucide-react";
...
const NAV = [
  { href: "/app/owner", label: "Overview", icon: LayoutDashboard, exact: true },
  { href: "/app/owner/locations", label: "My locations", icon: MapPin },
  { href: "/app/owner/earnings", label: "Earnings", icon: Wallet },
  { href: "/app/admin/devices", label: "Devices", icon: MonitorSpeaker },
  { href: "/marketplace", label: "Marketplace", icon: Store },
];

export function OwnerShell({ children, userEmail }: { children: React.ReactNode; userEmail?: string }) {
